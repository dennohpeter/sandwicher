...
contract ContractTest is Test {
    ...
    uint256 public blockNumber = 22154580;

    function setUp() public {
        vm.createFork(MAINNET_RPC_URL, blockNumber);
    ...
    function testRugCheck() public {
        ...
        address rugToken = 0xa438780470F5297Dea52d7f3cB5c7f10fe65EA59;
        assertEq(fromToken.balanceOf(address(sandWicher)), amount);
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = rugToken;
        ...
        assertGt(IERC20(rugToken).balanceOf(address(sandWicher)), 0);
        ...
        //     )
        // );
        // assertEq(IERC20(rugToken).balanceOf(address(sandWicher)), 0);
